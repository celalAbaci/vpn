...
public class PremiumActivity extends BaseActivity {
    ...
    private LinearLayout weeklyPlanLayout;
    private LinearLayout monthlyPlanLayout;
    private LinearLayout yearlyPlanLayout;
    ...
    private void selectPlan(PlanType planType) {
        ...
        // Tüm kartları seçilmemiş hale getir
        weeklyPlanLayout.setBackgroundResource(R.drawable.bg_plan_normal);
        monthlyPlanLayout.setBackgroundResource(R.drawable.bg_plan_normal);
        yearlyPlanLayout.setBackgroundResource(R.drawable.bg_plan_normal);
        ...
        // Seçili planı vurgula
        switch (planType) {
            case WEEKLY:
                weeklyPlanLayout.setBackgroundResource(R.drawable.bg_plan_selected);
                btnBuyWeekly.setBackgroundResource(R.drawable.bg_buy_button_premium);
                btnBuyWeekly.setTextColor(getResources().getColor(R.color.main_background));
                break;
            case MONTHLY:
                monthlyPlanLayout.setBackgroundResource(R.drawable.bg_plan_selected);
                btnBuyMonthly.setBackgroundResource(R.drawable.bg_buy_button_premium);
                btnBuyMonthly.setTextColor(getResources().getColor(R.color.main_background));
                break;
            case YEARLY:
                yearlyPlanLayout.setBackgroundResource(R.drawable.bg_plan_selected);
                btnBuyYearly.setBackgroundResource(R.drawable.bg_buy_button_premium);
                btnBuyYearly.setTextColor(getResources().getColor(R.color.main_background));
                break;
        }
    }
