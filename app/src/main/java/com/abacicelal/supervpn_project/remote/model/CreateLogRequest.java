...
public class CreateLogRequest {
    ...
    @SerializedName("assignedVpnIp")
    private String assignedVpnIp; // (opsiyonel) — VPN sunucusunun atadığı iç tünel IP'si
    ...
    public void setAssignedVpnIp(String assignedVpnIp) {
        this.assignedVpnIp = assignedVpnIp;
    }
}
