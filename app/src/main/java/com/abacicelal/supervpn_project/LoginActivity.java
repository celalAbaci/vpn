...
public class LoginActivity extends BaseActivity {
    ...
    private void continueAsGuest() {
        ...
        com.abacicelal.supervpn_project.remote.model.GuestAuthRequest authRequest = new com.abacicelal.supervpn_project.remote.model.GuestAuthRequest(deviceId, deviceName);

        Call<AuthResponse> call = RetrofitClient.getApiService(getApplicationContext()).loginGuest(authRequest);
        call.enqueue(new Callback<AuthResponse>() {
            ...
            public void onResponse(Call<AuthResponse> call, Response<AuthResponse> response) {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Toast.makeText(LoginActivity.this, "Misafir girişi başarısız!", Toast.LENGTH_LONG).show();
                }
            }
