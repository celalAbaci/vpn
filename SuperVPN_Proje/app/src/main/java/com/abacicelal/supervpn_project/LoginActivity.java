...
public class LoginActivity extends AppCompatActivity {
    ...
    private void continueAsGuest() {
        ...
        GuestLoginRequest request = new GuestLoginRequest(deviceId, android.os.Build.MODEL);
        ...
        RetrofitClient.getApiService(getApplicationContext()).guestLogin(request).enqueue(new Callback<AuthResponse>() {
            ...
            public void onResponse(Call<AuthResponse> call, Response<AuthResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    RetrofitClient.saveToken(LoginActivity.this,
                            ...
                            null); // Guest has no refresh token
            ...
            public void onFailure(Call<AuthResponse> call, Throwable t) {
                ...
                // Opsiyonel: İnternet yoksa bile ana sayfaya atılabilir, ama backend bağlantısı şart.
            }
        });
    }
