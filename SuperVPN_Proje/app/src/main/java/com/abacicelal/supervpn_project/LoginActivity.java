...
public class LoginActivity extends AppCompatActivity {
    ...
    private void continueAsGuest() {
        ...
        Call<GuestLoginResponse> call = RetrofitClient.getApiService(getApplicationContext()).guestLogin(request);
            ...
            public void onResponse(Call<GuestLoginResponse> call, Response<GuestLoginResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                     RetrofitClient.saveToken(LoginActivity.this,
                            ...
                            null); // Refresh token might be null for guests

                     // Save Registered Device ID if needed
